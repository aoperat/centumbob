...
const ComplaintModal = ({ isOpen, onClose, restaurants, dateRanges }) => {
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span
                              className={`px-2 py-1 rounded text-xs font-bold ${getCategoryColor(
                                complaint.category
                              )}`}
                            >
                              {complaint.category}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="text-sm text-slate-500 space-y-1">
                  ...
                  <div>
                    작성자: {selectedComplaint.user_name} ({selectedComplaint.user_email})
                  </div>
                  <div>
                    작성일:{" "}
                    {new Date(selectedComplaint.created_at).toLocaleString("ko-KR")}
                  </div>
                </div>
              </div>
