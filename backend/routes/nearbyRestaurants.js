...
// =====================
// 꿀팁 API (specific routes must come before /:id)
// =====================
...
// =====================
// 찜하기 API (specific routes)
// =====================

/**
 * 사용자 찜 목록 조회
 * GET /api/nearby-restaurants/user/bookmarks?user_id=xxx
 */
...
// =====================
// 식당 상세 API (wildcard routes - must come AFTER specific routes)
// =====================
